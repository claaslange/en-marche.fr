...
class PayboxPaymentUnsubscriptionTest extends WebTestCase
{
    ...
    {
        $request = static::createRequestDonation();
        $factory = static::createDonationFactory();
    ...
    private static function createDonationFactory(): DonationFactory
    {
        return new DonationFactory();
    }

    private static function createRequestDonation(): DonationRequest
    {
