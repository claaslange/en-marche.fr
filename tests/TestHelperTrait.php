...
trait TestHelperTrait
{
    ...
    public function getAdherentEmailSubscriptionHistoryRepository(): AdherentEmailSubscriptionHistoryRepository
    {
        return $this->getRepository(AdherentEmailSubscriptionHistory::class);
    }
